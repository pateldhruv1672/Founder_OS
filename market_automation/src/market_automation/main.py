#!/usr/bin/env python
import sys
from marketing_content_studio___lead_generation_conversion_automation.crew import MarketingContentStudioLeadGenerationConversionAutomationCrew
...
def replay():
    ...
    """
    try:
        MarketingContentStudioLeadGenerationConversionAutomationCrew().crew().replay(task_id=sys.argv[1])
